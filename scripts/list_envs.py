...
All the environments are registered in the `byte_01_v1` extension. They start
...
import byte_01_v1.tasks  # noqa: F401


def main():
    """Print all environments registered in `byte_01_v1` extension."""
